...
type GameDvaFacts() =
    ...
    member val bitchWantsMoney =
        createFact 
            "bwm" 
            "Эта сука хочет денег" 
            "А кто ж не хочет. У тебя еще и будут."
    ...
    member val policeIsComing =
        createFact "policeComes" "Полиция в пути" """Похоже, когда я проснулась - полиция уже направлялась сюда. 
