        ...
        [ window "init" {
          ...
          window "откр" {
            ...
            Теперь его прекрасно видно с каждого окна окружающих высоток."""
                """Ты открыла окно. Прохладный воздух нежно окутал твое тело.
            Теперь его прекрасно видно с каждого окна окружающих высоток. Хорошо хоть ты додумалась одеться.
                """
